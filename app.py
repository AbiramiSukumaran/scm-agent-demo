...
# If you don't have an Agent Engine instance already, create an instance. Otherwise update the instance.
agent_engine = client.agent_engines.create()

# Print the agent engine ID, you will need it in the later steps to initialize
# the ADK `VertexAiSessionService`. 
print(agent_engine.api_resource.name) #Set it up in the .env file for the REASONING_ENGINE_APP_NAME variable
print(agent_engine.api_resource.name.split("/")[-1])

# --- ADK TOOLBOX CONFIGURATION ---
toolbox = ToolboxSyncClient("https://toolbox-*****************-uc.a.run.app") #change this to your MCP Server
tools = toolbox.load_toolset('supply_chain_toolset')
